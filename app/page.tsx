    ...
    <main className="min-h-screen bg-slate-50 text-slate-900 font-sans">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-500">Une solution de conversion CSV vers Excel rapide, précise et prête pour vos besoins.</p>
        </div>
        ...
        <div className="bg-white p-2 rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100">
          ...
          <p className="mt-4 text-sm text-center text-slate-400">{fileName || "Glissez-déposez ou cliquez pour importer"}</p>
        </div>
